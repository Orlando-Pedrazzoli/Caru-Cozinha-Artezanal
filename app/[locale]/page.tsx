...
export default function MenuPage() {
  ...
  const filteredDishes = useMemo(() => {
    ...
    // Filtro por tipo de porção (individual/refeicao/festa/combo)
    if (filters.portionTypes.length > 0) {
      result = result.filter(dish => {
        const types = dish.portionTypes || [];
        return filters.portionTypes.some(t => types.includes(t));
      });
    }
        ...
        <footer className='border-t mt-12'>
          <div className='container mx-auto px-4 py-8 text-center space-y-4'>
            ...
            <div className='flex justify-center'>
              <a
                href='https://www.instagram.com/caru.cozinhaartesanal'
                target='_blank'
